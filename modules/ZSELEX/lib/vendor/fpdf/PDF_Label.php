 ...
 *           
 */
require_once ('modules/ZSELEX/lib/vendor/fpdf/fpdf.php');
class PDF_Label extends FPDF {
	...
	function Add_Label($text) {
		...
		// $start_x = $this->GetX();
		// $start_y = $this->GetY();
		// $this->Image($this->qrCodeImage, 150, $this->GetY(), 0, 0);
		// $this->SetXY($start_x + 40 + 2, $start_y);
	}
	...
	function Footerz() {
		...
		$this->Image ( 'modules/ZSELEX/lib/vendor/fpdf/myLogo.png', 198, 285, 0, 0 );
	}
}
