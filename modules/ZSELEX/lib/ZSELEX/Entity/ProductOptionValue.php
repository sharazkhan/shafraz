 ...
 * @ORM\Table(name="zselex_product_options_values")
 */
class ZSELEX_Entity_ProductOptionValue extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_ProductOption", inversedBy="option_values" , fetch="EAGER")
	 * @ORM\JoinColumn(name="option_id", referencedColumnName="option_id")
	 */
	protected $option;
	
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", inversedBy="shop_option_values" , fetch="EAGER")
