 ...
 * @ORM\Table(name="zselex_social_links")
 */
class ZSELEX_Entity_SocialLink extends Zikula_EntityAccess {
	 ...
	 */
	public $socl_link_id = 0;
	
	/**
	 * @ORM\Column(length=255)
	 * 
	 * @var string $socl_link_name.
	 */
	public $socl_link_name = '';
	 ...
	 * @return integer
	 */
	public function getSocl_link_id() {
		return $this->socl_link_id;
	}
	 ...
	 * @return string
	 */
	public function getSocl_link_name() {
		return $this->socl_link_name;
	}
	 ...
	 * @return void
	 */
	public function setSocl_link_name($socl_link_name) {
		$this->socl_link_name = $socl_link_name;
	}
	 ...
	 * @return integer
	 */
	public function getSocl_image() {
		return $this->socl_image;
	}
	 ...
	 * @return void
	 */
	public function setSocl_image($socl_image) {
		$this->socl_image = $socl_image;
	}
