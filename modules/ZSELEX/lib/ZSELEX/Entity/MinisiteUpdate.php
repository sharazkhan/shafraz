 ...
 * @ORM\Table(name="zselex_ministe_updates")
 */
class ZSELEX_Entity_MinisiteUpdate extends Zikula_EntityAccess {
	 ...
	 */
	public function getIs_updated_recent() {
		return $this->is_updated_recent;
	}
	 ...
	 */
	public function setIs_updated_recent($is_updated_recent) {
		$this->is_updated_recent = $is_updated_recent;
	}
