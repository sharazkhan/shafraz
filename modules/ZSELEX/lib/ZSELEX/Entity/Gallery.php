 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_GalleryRepository")
 * @ORM\Table(name="zselex_shop_gallery")
 */
class ZSELEX_Entity_Gallery extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", cascade={"all"}, inversedBy="shop_gallery")
