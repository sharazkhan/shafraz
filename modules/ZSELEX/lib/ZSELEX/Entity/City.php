 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_CityRepository")
 * @ORM\Table(name="zselex_city")
 */
class ZSELEX_Entity_City extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Region", inversedBy="city_regions")
	 * @ORM\JoinColumn(name="region_id", referencedColumnName="region_id")
	 */
	public $region = null;
	
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Country", inversedBy="city_countries")
	 * @ORM\JoinColumn(name="country_id", referencedColumnName="country_id")
	 */
	private $country = null;
	
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_Area" ,cascade={"all"}, mappedBy="city")
	 */
	public $area_cities;
	
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_Shop" ,cascade={"all"}, mappedBy="city")
	 */
	public $shop_cities;
	
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_Advertise" ,cascade={"all"}, mappedBy="city")
	 */
	public $city_ads;
	...
	public function __construct() {
		 ...
		 *
		 */
		$this->area_cities = new ArrayCollection ();
		$this->shop_cities = new ArrayCollection ();
		$this->city_ads = new ArrayCollection ();
	}
	...
	public function getCity_area() {
		return $this->city_area;
	}
	public function setCity_area($city_area) {
