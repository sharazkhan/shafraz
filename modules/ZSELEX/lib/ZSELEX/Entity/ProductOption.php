 ...
 * @ORM\Table(name="zselex_product_options")
 */
class ZSELEX_Entity_ProductOption extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", inversedBy="shop_options" , fetch="EAGER")
	...
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_ProductOptionValue" , cascade={"all"} , mappedBy="option")
	 */
	public $option_values;
	
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_ProductToOption" , cascade={"all"} , mappedBy="option")
	 */
	public $option_products;
	
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_ProductToOptionValue" , cascade={"all"} , mappedBy="option")
	 */
	public $option_product_values;
	...
	public function __construct() {
		...
		$this->option_products = new ArrayCollection ();
		$this->option_product_values = new ArrayCollection ();
	}
	...
	public function setOption_value($option_value) {
		if ($option_value != $this->option_value) {
	...
	public function setOption_type($option_type) {
		if ($option_type != $this->option_type) {
	...
	public function setParent_option_id($parent_option_id) {
		if ($parent_option_id != $this->parent_option_id) {
