 ...
 * @ORM\Table(name="zselex_product_quantity_discount")
 */
class ZSELEX_Entity_QuantityDiscount extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Product", inversedBy="quantity_discounts")
