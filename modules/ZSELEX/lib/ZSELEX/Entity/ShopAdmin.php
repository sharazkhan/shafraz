 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_ShopAdminRepository")
 * @ORM\Table(name="zselex_shop_admins")
 */
class ZSELEX_Entity_ShopAdmin extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", cascade={"all"}, inversedBy="shop_admins")
