 ...
 * @ORM\Table(name="zselex_social_links_shop")
 */
class ZSELEX_Entity_SocialLinkShop extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_SocialLink", cascade={"all"}, inversedBy="social_links")
	 * @ORM\JoinColumn(name="socl_link_id", referencedColumnName="socl_link_id")
	 */
	public $socl_links;
	
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", cascade={"all"})
	 ...
	 * @return string
	 */
	public function getSocl_links($socl_links) {
		return $this->socl_links;
	}
	 ...
	 * @return void
	 */
	public function setSocl_links(ZSELEX_Entity_SocialLink $socl_links) {
		$this->socl_links = $socl_links;
	}
	 ...
	 */
	public function setIcon_size($icon_size) {
