 ...
 * @ORM\Table(name="zselex_advertise_price")
 */
class ZSELEX_Entity_AdvertisePrice extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_Advertise" ,cascade={"all"}, mappedBy="adprice")
	 */
	public $advertise_prices;
	...
	public function __construct() {
		$this->advertise_prices = new ArrayCollection ();
	}
	 ...
	 * @return integer
	 */
	public function getAdprice_id() {
		return $this->adprice_id;
	}
