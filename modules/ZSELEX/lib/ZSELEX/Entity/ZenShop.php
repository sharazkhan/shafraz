 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_ZenShopRepository")
 * @ORM\Table(name="zselex_zenshop")
 */
class ZSELEX_Entity_ZenShop extends Zikula_EntityAccess {
	 ...
	 * @var int $name.
	 */
	protected $minishop_id;
	
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop" , inversedBy="shop_zencarts")
	 ...
	 * @return integer
	 */
	public function getZen_id() {
		return $this->zen_id;
	}
	public function getMinishop_id() {
		return $this->minishop_id;
	}
	public function setMinishop_id($minishop_id) {
		$this->minishop_id = $minishop_id;
	}
