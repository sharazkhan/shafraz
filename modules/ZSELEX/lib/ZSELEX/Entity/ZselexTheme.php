 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_ThemeRepository")
 * @ORM\Table(name="zselex_themes")
 */
class ZSELEX_Entity_ZselexTheme extends Zikula_EntityAccess {
