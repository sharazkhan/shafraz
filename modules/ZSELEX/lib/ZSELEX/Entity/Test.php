 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_Type")
 * @ORM\Table(name="zselex_test")
 */
class ZSELEX_Entity_Test extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToMany(targetEntity="ZSELEX_Entity_ProductCategory")
	 * @ORM\JoinTable(name="zselex_product_to_test",
	 * joinColumns={@ORM\JoinColumn(name="test_id", referencedColumnName="id")},
	 * inverseJoinColumns={@ORM\JoinColumn(name="cat_id", referencedColumnName="prd_cat_id")}
	 * )
	 */
	protected $prod_cats;
	...
	public function __construct() {
		 ...
		 *
		 */
		$this->prod_cats = new ArrayCollection ();
	}
	...
	public function getProd_cats() {
		return $this->prod_cats;
	}
	public function setProd_cats($prod_cats) {
		return $this->prod_cats;
	}
