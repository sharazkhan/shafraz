 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_MiniShopRepository")
 * @ORM\Table(name="zselex_minishop")
 */
class ZSELEX_Entity_MiniShop extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", inversedBy="minishops")
	 ...
	 * @ORM\Column(length=255 , nullable=true)
	 * 
	 * @var string $minishop_name.
	 */
	public $minishop_name = null;
	...
	public function getMinishop_name() {
		return $this->minishop_name;
	}
	public function setMinishop_name($minishop_name) {
		$this->minishop_name = $minishop_name;
	}
