 ...
 *
 *
 * @ORM\Entity(repositoryClass="ZSELEX_Entity_Repository_RatingRepository")
 * @ORM\Table(name="zselex_shop_ratings" , indexes={@ORM\index(columns={"shop_id"})})
 */
class ZSELEX_Entity_Rating extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", inversedBy="shop_ratings")
