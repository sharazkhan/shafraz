 ...
 * @ORM\Table(name="zselex_product_to_options")
 */
class ZSELEX_Entity_ProductToOption extends Zikula_EntityAccess {
	 ...
	 */
	protected $product_to_options_id;
	
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Product", inversedBy="product_options" , fetch="EAGER")
	 * @ORM\JoinColumn(name="product_id", referencedColumnName="product_id")
	 */
	public $product;
	
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_ProductOption", inversedBy="option_products" , fetch="EAGER")
	...
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_ProductToOptionValue" , cascade={"all"} , mappedBy="product_to_option" , fetch="EAGER")
	 */
	public $product_to_options_values;
	...
	public function __construct() {
		$this->product_to_options_values = new ArrayCollection ();
	}
	 ...
	 * @return integer
	 */
	public function getProduct_to_options_id() {
		return $this->product_to_options_id;
	}
