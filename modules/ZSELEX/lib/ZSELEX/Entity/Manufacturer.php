 ...
 * @ORM\Table(name="zselex_manufacturer")
 */
class ZSELEX_Entity_Manufacturer extends Zikula_EntityAccess {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ZSELEX_Entity_Shop", inversedBy="shop_manufacturers")
	...
	/**
	 * @ORM\OneToMany(targetEntity="ZSELEX_Entity_Product" ,cascade={"all"}, mappedBy="manufacturer")
	 */
	...
	public function __construct() {
		 ...
		 *
		 */
		$this->product_manufacturer = new ArrayCollection ();
	}
	...
	public function setManufacturer_id($manufacturer_id) {
		if ($manufacturer_id != $this->manufacturer_id) {
	...
	public function setManufacturer_name($manufacturer_name) {
		if ($manufacturer_name != $this->manufacturer_name) {
