 ...
 * @ORM\Table(name="zselex_shop_details")
 */
class ZSELEX_Entity_ShopDetail extends Zikula_EntityAccess {
	...
	/**
	 *
	 * @param text $terms_condition_text.        	
	 *
	 * @return void
	 */
	public function setTerms_conditions($terms_conditions) {
		if ($terms_conditions != $this->terms_conditions) {
