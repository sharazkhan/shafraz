 ...
 */
class ZSELEX_HookHandlers extends Zikula_Hook_AbstractHandler {
	...
	public function uiView(Zikula_DisplayHook $hook) {
		...
		// Get the new output
		$result = ModUtil::func ( 'Ratings', 'user', 'display', array (
				'objectid' => $objectid,
				'areaid' => $areaid,
				'modname' => $mod,
				'extrainfo' => array (
		...
		$view->assign ( 'areaid', $areaid )->assign ( 'result', $result );
