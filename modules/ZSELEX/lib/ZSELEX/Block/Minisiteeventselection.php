 ...
 */
class ZSELEX_Block_Minisiteeventselection extends Zikula_Controller_AbstractBlock {
	
	/**
	 * initialise block
	 */
	public function init() {
		SecurityUtil::registerPermissionSchema ( 'ZSELEX:minisiteeventselection:', 'Block title::' );
	}
	...
	public function display($blockinfo) {
		...
		if (! SecurityUtil::checkPermission ( 'ZSELEX:minisiteeventselection:', "$blockinfo[title]::", ACCESS_OVERVIEW )) {
			return;
		}
		...
		$blockinfo ['content'] = $this->view->fetch ( 'blocks/minisiteeventselection/minisiteeventselection.tpl' );
	...
	public function modify($blockinfo) {
		...
		return $this->view->fetch ( 'blocks/minisiteeventselection/minisiteeventselection_modify.tpl' );
	}
