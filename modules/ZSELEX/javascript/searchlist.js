...
function getCityListAllResponses(req)
{
    ...
    jQuery("#city-combo1").ZselexCombo({emptyText: "Choose a city..."});
}
...
function getAllCatResponse(req)
{
    ...
    jQuery("#cat-combo").ZselexCombo({emptyText: Zikula.__('Choose a category...', 'module_zselex_js')});
...
function displayBlocks() {
    // alert(window.location.href.split('?')[0]); exit();
...
jQuery(document).ready(function () {
    ...
    jQuery("#region-combo").live('change', function () {
    ...
    jQuery("#city-combo1").live('change', function () {
...
function closeBcLi(id) {
    ...
    if (id == 'bc_cat') {
        ...
        jQuery("#region-combo").ZselexCombo({emptyText: Zikula.__('search region', 'module_zselex_js')});
        ...
        jQuery("#city-combo1").ZselexCombo({emptyText: Zikula.__('search city', 'module_zselex_js')});
