...
/**
 * Smarty function to display the category menu for admin links.
 * This also adds the
...
function smarty_function_admincategorymenu($params, $view) {
	...
	$acid = ModUtil::apiFunc ( 'Admin', 'admin', 'getmodcategory', array (
			'mid' => $modinfo ['id'] 
	) );
	
	return ModUtil::func ( 'Admin', 'admin', 'categorymenu', array (
			'acid' => $acid 
	) );
}
