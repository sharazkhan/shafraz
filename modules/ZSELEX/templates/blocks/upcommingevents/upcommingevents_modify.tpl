{pageaddvar name='javascript' value='jquery'}
         ...
         <div class="z-formrow" >
             <label for="upcommingeventlimit">{gt text="No of events to display"}</label>
             <input type="text" id="upcommingeventlimit" name="upcommingeventlimit" value="{$vars.upcommingeventlimit }" />
        </div>  
      <div class="z-formrow">
