...
<form id='form' name='form' action='' method='get'>
    ...
    <div class="PageBreak">    
     <div class="CurvedBoxSec right"><input type="button" value="VIS RESULTATER" />   </div>     
     <div class="FieldSet right">
          ...
          <div class="PaddingAdjst"> {gt text="Search"} : <input type="textbox" value="" id="hsearch" onkeyup="searchvalue(this.value)" size="24"> </div>
