       ...
       <table id="zselex_admintable" class="z-datatable">
            ...
            <tbody>
                ...
                <tr class="{cycle values='z-odd,z-even'}">
                    ...
                    <td><a href='index.php?module=zselex&type=admin&func=modifydotd&dotdId={$item.dotdId}&shop_id={$item.shop_id}'>{gt text='Edit'}</a></td>
                    <td><a href='index.php?module=zselex&type=admin&func=deleteDotd&dotdId={$item.dotdId}&shop_id={$item.shop_id}'>{gt text='Delete'}</a></td>
                </tr>
