   ...
   <div class="z-formrow">
      ...
      <label for="level">{gt text='Select Level'}</label>
          ...
          <div class="z-formrow">
            ...
            <a id="zselex_button_cancel" href="{modurl modname="ZSELEX" type="admin" func='viewarticleads' shop_id=$shop_id}" class="z-btred">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
            </div>
        </div>
	</form>
