...
<div class="z-admin-content-pagetitle">
    ...
    {if $perm eq 1}
    <a href="index.php?module=zselex&amp;type=admin&amp;func=createadvertise&shop_id={$shop_id}" class="z-iconlink z-icon-es-add">{gt text='Create Advertise'}</a>
    {/if}
    {* {/if} *}
...
<form class="z-form" id="advertise_filter" action="{modurl modname='ZSELEX' type='admin' func='viewadvertise' shop_id=$smarty.request.shop_id}" method="post" enctype="application/x-www-form-urlencoded">
    ...
    <div style="overflow:auto;">
        ...
        <table id="zselex_admintable" class="z-datatable">
            ...
            <tbody>
                ...
                <tr class="{cycle values='z-odd,z-even'}">
                   <!--   <td><input type="checkbox" name="zselex_selected_advertises[]" value="{$advertiseitem.advertise_id}" class="zselex_checkbox" /></td> -->
                    ...
                    <td>
                        ...
                        <a href="{$options[options].url|safetext}"  {if $options[options].val eq 'delete'} id="confirmdialog" onclick="deleteConfirm()"  {/if}>
                ...
                <td>{$advertiseitem.area_name|safetext}</td>
