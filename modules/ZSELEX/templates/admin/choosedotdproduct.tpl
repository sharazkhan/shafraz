  ...
  <script type="text/javascript">
            $(document).ready(function() {
                ...
                if(pw){
                       ...
                       var dotKeywords = pw.document.getElementById('keywords').value;
                       document.getElementById('dotd_name').value=dotName;
                       document.getElementById('dotd_date').value=dotDate;
                       document.getElementById('keywords').value=dotKeywords;
                        //alert(dotName);
                        //alert(dotDate);
                        //alert(dotKeywords);
                }
...
<div id="body">
<form class="z-form" id="shop_filter" action="{modurl modname='ZSELEX' type='admin' func='chooseIshopDodtProduct' shop_id=$smarty.request.shop_id}" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset id="zselex_multicategory_filter"{if $filter_active} class='filteractive'{/if}>
        ...
        <span class="z-nowrap z-buttons">
            ...
            <a href="{modurl modname="ZSELEX" type='admin' func='viewshop'}" title="{gt text="Clear"}">{img modname=core src="button_cancel.png" set="icons/extrasmall" __alt="Clear" __title="Clear"} {gt text="Clear"}</a>
        </span>
    </fieldset>
</form>

<form class="z-form" id="zselex_bulkaction_form" action="{modurl modname='ZSELEX' type='admin' func='chooseIshopDodtProduct' shop_id=$smarty.request.shop_id}" method="post">
       ...
       <table id="zselex_admintable" class="z-datatable">
            ...
            <tbody>
                ...
                <tr class="{cycle values='z-odd,z-even'}">
                    ...
                    <td><input type="radio" name="iproduct" id="iproduct" value="{$item.product_id}"></td>
                    <td></td>
