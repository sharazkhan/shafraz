{strip}
    ...
    {ajaxheader modname=$modinfo.name filename='users/Zikula.Users.NewUser.js' noscriptaculous=true effects=true}
    {ajaxheader modname=$modinfo.name filename='users/Zikula.Users.Admin.NewUser.js' noscriptaculous=true effects=true}
    {if $modvars.Users.use_password_strength_meter == 1}
        {pageaddvar name='javascript' value='prototype'}
        {pageaddvar name='javascript' value='modules/ZSELEX/javascript/users/Zikula.Users.PassMeter.js'}
        {pageaddvarblock}
...
{/if}
<form id="{$formData->getFormId()}" class="z-form" action="{modurl modname='ZSELEX' type='adminusers' func='modifyOwner' shop_id=$smarty.request.shop_id}" method="post">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formbuttons z-buttons">
                ...
                <a href="{modurl modname='ZSELEX' type='adminusers' func='view' shop_id=$smarty.request.shop_id}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
            </div>
        </fieldset>
    </div>
</form>
...
<div class="z-center z-buttons">
    {if !$editingSelf}<a href="{modurl modname='ZSELEX' type='adminusers' func='deleteusers' shop_id=$smarty.request.shop_id userid=$formData->getFieldData('uid')}">{img modname='core' set='icons/extrasmall' src="delete_user.png" __alt='Delete' __title='Delete'} {gt text='Delete'}</a>{/if}
    <a href="{modurl modname='ZSELEX' type='adminusers' func='lostUsername' uid=$formData->getFieldData('uid') shop_id=$smarty.request.shop_id csrftoken=$csrftoken}">{img modname='core' set='icons/extrasmall' src="lostusername.png" __alt='Send user name' __title='Send user name'} {gt text='Send user name'}</a>
    <a href="{modurl modname='ZSELEX' type='adminusers' func='lostPassword' uid=$formData->getFieldData('uid') shop_id=$smarty.request.shop_id csrftoken=$csrftoken}">{img modname='core' set='icons/extrasmall' src="lostpassword.png" __alt='Send password recovery code' __title='Send password recovery code'} {gt text='Send password recovery code'}</a>
</div>
