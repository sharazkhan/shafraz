...
{*
<div align="right"><a href="{modurl modname="ZSELEX" type="admin" func="shopinnerview" shop_id=$smarty.request.shop_id}">{gt text='Back to Shop'}</a></div>
*}
...
<form id="{$formData->getFormId()}" class="z-form" action="{modurl modname='ZSELEX' type='adminusers' func='newOwner' shop_id=$smarty.request.shop_id}" method="post">
     <input type="hidden" id="shopOwnerGroup" name="shopOwnerGroup" value="{$modvars.ZSELEX.shopOwnerGroup}" />
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formbuttons z-buttons">
                ...
                <a href="{modurl modname='ZSELEX' type='adminusers' func='viewOwner' shop_id=$smarty.request.shop_id}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
            </div>
        </fieldset>
    </div>
</form>
