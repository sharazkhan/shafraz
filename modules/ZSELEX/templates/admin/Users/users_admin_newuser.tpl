...
<form id="{$formData->getFormId()}" class="z-form" action="{modurl modname='ZSELEX' type='adminusers' func='newUser' shop_id=$smarty.request.shop_id}" method="post">
     <input type="hidden" id="shopAdminGroup" name="shopAdminGroup" value="{$modvars.ZSELEX.shopAdminGroup}" />
    <div>
