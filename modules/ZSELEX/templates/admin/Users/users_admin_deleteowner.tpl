...
<form class="z-form" action="{modurl modname='ZSELEX' type='adminusers' func='deleteOwner' shop_id=$smarty.request.shop_id}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        
        <input type="hidden" name="usersid" value="{$smarty.request.userid}" />
        ...
        <div class="z-formbuttons z-buttons">
            ...
            <a class="z-btred" href="{modurl modname='ZSELEX' type='adminusers' func='viewOwner' shop_id=$smarty.request.shop_id}" title="{gt text='Cancel'}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
        </div>
    </div>
</form>
