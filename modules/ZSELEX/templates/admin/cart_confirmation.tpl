...
<p class="z-warningmsg">{gt text='Do you want to Confirm this Order?'}</p>

<form class="z-form" action="{modurl modname='ZSELEX' type='admin' func='confirmServiceOrder' shop_id=$smarty.request.shop_id}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formbuttons z-buttons">
                ...
                <a class="z-btred" href="
                   ...
                   {else}
                   {modurl modname='ZSELEX' type='admin' func='serviceOrder'}  
                       {/if}
