       ...
       <table id="zselex_admintable" class="z-datatable">
            ...
            <tbody>
                ...
                <tr class="{cycle values='z-odd,z-even'}">
                    <td><input type="checkbox" name="zselex_selected_articles[]" value="{$typeitem.type_id}" class="zselex_checkbox" /></td>
                    <td>{$typeitem.type_id|safetext}</td>
                    <td>{$typeitem.type_name|safetext}</td>
                    <td>{$typeitem.description|safetext}</td>
                    <td>{$typeitem.status|safetext}</td>
                    <td>{$typeitem.cr_uid|safetext}</td>
                    <td>{$typeitem.cr_date|safetext}</td>
                    <td>{$typeitem.lu_uid|safetext}</td>
