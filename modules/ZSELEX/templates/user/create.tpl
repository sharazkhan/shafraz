...
<form id="news_user_newform" class="z-form" action="{modurl modname='ZSELEX' type='usernews' func='creates'}" method="post" enctype="{if $accesspicupload AND $modvars.News.picupload_enabled}multipart/form-data{else}application/x-www-form-urlencoded{/if}">
    <div>
        <input type="hidden" name="story[shop_id]" value="{$smarty.request.shop_id}" />
