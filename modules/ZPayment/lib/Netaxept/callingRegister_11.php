...
echo "<h3><font color='blue'>This example is showing you how to call Register function having Recurring Parameters (withdraw client money by using Panhash): required Card Security Code on the Terminal</font></h3>";
...
$serviceType          = "B";  // Optional parameter: null ==> default = "B" <=> BBS HOSTED
