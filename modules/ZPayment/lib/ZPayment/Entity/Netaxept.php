 ...
 *
 * 
 * @ORM\Entity(repositoryClass="ZPayment_Entity_Repository_Netaxept")
 * @ORM\Table(name="zpayment_netaxept")
 */
class ZPayment_Entity_Netaxept extends Zikula_EntityAccess {
     ...
     */
    protected $zselex_order_id = '';

    /**
     * @ORM\Column(length=255)
     * @var integer $status.
     */
    protected $nets_transaction_id = '';
     ...
     * @return string
     */
    public function getZselex_order_id() {
        return $this->zselex_order_id;
    }
     ...
     * @return void
     */
    public function setZselex_order_id($zselex_order_id) {
        if ($zselex_order_id != $this->zselex_order_id) {
            $this->zselex_order_id = $zselex_order_id;
        }
    }
     ...
     * @return integer
     */
    public function getNets_transaction_id() {
        return $this->nets_transaction_id;
    }
     ...
     * @return void
     */
    public function setNets_transaction_id($nets_transaction_id) {
        if ($nets_transaction_id != $this->nets_transaction_id) {
            $this->nets_transaction_id = $nets_transaction_id;
        }
    }
