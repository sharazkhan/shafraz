 ...
 *
 * 
 * @ORM\Entity(repositoryClass="ZPayment_Entity_Repository_Epay")
 * @ORM\Table(name="zpayment_epay_settings")
 */
class ZPayment_Entity_EpaySetting extends Zikula_EntityAccess {
     ...
     * @var int $test_merchant_number.
     */
    protected $test_merchant_number = '';

    /**
     * @ORM\Column(length=500)
     * @var int $merchant_number.
     */
    ...
    public function getMerchant_number() {
        return $this->merchant_number;
    }

    public function setMerchant_number($merchant_number) {
        if ($merchant_number != $this->merchant_number) {
            $this->merchant_number = $merchant_number;
        }
    }

    public function getTest_merchant_number() {
        return $this->test_merchant_number;
    }

    public function setTest_merchant_number($test_merchant_number) {
        if ($test_merchant_number != $this->test_merchant_number) {
            $this->test_merchant_number = $test_merchant_number;
        }
    }

    public function getMd5_hash() {
        return $this->md5_hash;
    }

    public function setMd5_hash($md5_hash) {
        if ($md5_hash != $this->md5_hash) {
