 ...
 *
 * 
 * @ORM\Entity(repositoryClass="ZPayment_Entity_Repository_Directpay")
 * @ORM\Table(name="zpayment_directpay_settings")
 */
class ZPayment_Entity_DirectpaySetting extends Zikula_EntityAccess {
