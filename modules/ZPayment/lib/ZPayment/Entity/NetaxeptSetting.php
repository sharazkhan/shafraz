 ...
 * @ORM\Table(name="zpayment_netaxept_settings")
 */
class ZPayment_Entity_NetaxeptSetting extends Zikula_EntityAccess {
    ...
    public function getTest_merchant_id() {
        return $this->test_merchant_id;
    }

    public function setTest_merchant_id($test_merchant_id) {
        if ($test_merchant_id != $this->test_merchant_id) {
            $this->test_merchant_id = $test_merchant_id;
        }
    }

    public function getTest_token() {
        return $this->test_token;
    }

    public function setTest_token($test_token) {
        if ($token != $this->test_token) {
