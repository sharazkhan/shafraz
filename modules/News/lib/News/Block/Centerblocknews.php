 ...
 */
class News_Block_Centerblocknews extends Zikula_Controller_AbstractBlock {
    ...
    public function init() {
        SecurityUtil::registerPermissionSchema('Centerblocknewsblock::', 'Block ID::');
    }
    ...
    public function info() {
        return array('module' => 'News',
            'text_type' => $this->__('Display News In Center'),
            'text_type_long' => $this->__('Display News In Center'),
            'allow_multiple' => true,
            'form_content' => false,
            'form_refresh' => false,
            'show_preview' => true,
    ...
    public function display($blockinfo) {
        ...
        if (!SecurityUtil::checkPermission('Centerblocknewsblock::', "$blockinfo[bid]::", ACCESS_OVERVIEW)) {
            return;
        }
...
height:50px;
        ...
        if (!empty($vars['rowtemplate'])) {
            ...
            $rowtemplate = 'block/centerblocknews/row.tpl';
        }
        ...
        if (!empty($vars['blocktemplate'])) {
            ...
            $blocktemplate = 'block/centerblocknews/main.tpl';
            if ((int) $vars['scrolling'] > 1) {
                switch ((int) $vars['scrolling']) {
                    case 2:
                        $blocktemplate = 'block/centerblocknews/scrollpause.tpl';
                        break;
                    case 3:
                        $blocktemplate = 'block/centerblocknews/scrollfade.tpl';
                        ...
                        break;
                    case 4:
                        $blocktemplate = 'block/centerblocknews/scrollmarquee.tpl';
...
height:50px;
        ...
        return $this->view->fetch('block/centerblocknews/modify.tpl');
    }
