 ...
 */
class News_Block_Frontpagedisplay extends Zikula_Controller_AbstractBlock {
    ...
    public function init() {
        SecurityUtil::registerPermissionSchema('Frontpagedisplayblock::', 'Block ID::');
    }
    ...
    public function info() {
        return array('module' => 'News',
            'text_type' => $this->__('Front Page Articles'),
            'text_type_long' => $this->__('Display front page articles'),
            'allow_multiple' => true,
            'form_content' => false,
            'form_refresh' => false,
            'show_preview' => true,
    ...
    public function display($blockinfo) {
        ...
        if (!SecurityUtil::checkPermission('Frontpagedisplayblock::', "$blockinfo[bid]::", ACCESS_OVERVIEW)) {
            return;
        }
...
//        }
        ...
        if (!empty($vars['rowtemplate'])) {
            ...
            $rowtemplate = 'block/frontpagedisplay/row.tpl';
        }
        ...
        if (!empty($vars['blocktemplate'])) {
            ...
            $blocktemplate = 'block/frontpagedisplay/main.tpl';
            if ((int) $vars['scrolling'] > 1) {
                switch ((int) $vars['scrolling']) {
                    case 2:
                        $blocktemplate = 'block/frontpagedisplay/scrollpause.tpl';
                        break;
                    case 3:
...
height:50px;
        ...
        return $this->view->fetch('block/frontpagedisplay/modify.tpl');
    }
