 ...
 */
class News_Block_Shoparticles extends Zikula_Controller_AbstractBlock {
    ...
    public function init() {
        SecurityUtil::registerPermissionSchema('Shoparticlesblock::', 'Block ID::');
    }
    ...
    public function info() {
        return array('module' => 'News',
            'text_type' => $this->__('Shop Articles'),
            'text_type_long' => $this->__('Display shop articles'),
            'allow_multiple' => true,
            'form_content' => false,
            'form_refresh' => false,
            'show_preview' => true,
    ...
    public function display($blockinfo) {
        ...
        if (!SecurityUtil::checkPermission('Shoparticlesblock::', "$blockinfo[bid]::", ACCESS_OVERVIEW)) {
            return;
        }
...
//        if($_REQUEST['func']=='shop' || $_REQUEST['func']=='view') {
//       //echo "comes here";
//        $items = ModUtil::apiFunc('ZSELEX', 'user', 'getall', $apiargs);   
//        }
//        
//        else{
//            //echo "hellooo";
...
//        }
        ...
        /*
          if ($_REQUEST['func'] == 'shop' || ($_REQUEST['module'] == 'ZSELEX' && $_REQUEST['func'] == 'newitem')) {
          // echo "comes here";
          $items = ModUtil::apiFunc('News', 'block', 'getall1', $apiargs);
          } else {
          //echo "hellooo";
          $items = ModUtil::apiFunc('News', 'block', 'getall1', $apiargs);
          }
        ...
        $items = ModUtil::apiFunc('News', 'block', 'getall', $apiargs);
        ...
        if (!empty($vars['rowtemplate'])) {
            ...
            $rowtemplate = 'block/shoparticles/row.tpl';
        }

        //echo "<pre>"; print_r($items);  echo "</pre>";
        $shop_id = $_REQUEST['shop_id'];
        $serviceargs = array('shop_id' => $shop_id, 'type' => 'youtubelink');
        $serviceargs = array('shop_id' => $shop_id, 'type' => 'youtubelink');
        ...
        foreach ($items as $item) {
            ...
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //echo "pictures :" . $item['pictures'] . '<br>';
            // $this->view->assign('picture', $item['pictures']);
        ...
        if (!empty($vars['blocktemplate'])) {
            ...
            $blocktemplate = 'block/shoparticles/main.tpl';
            if ((int) $vars['scrolling'] > 1) {
                switch ((int) $vars['scrolling']) {
                    case 2:
                        $blocktemplate = 'block/shoparticles/scrollpause.tpl';
                        break;
                    case 3:
                        $blocktemplate = 'block/frontpagedisplay/scrollfade.tpl';
                        ...
                        break;
                    case 4:
                        $blocktemplate = 'block/frontpagedisplay/scrollmarquee.tpl';
        ...
        //echo "<pre>"; print_r($storiesoutput);  echo "</pre>";
...
height:50px;
        ...
        return $this->view->fetch('block/shoparticles/modify.tpl');
    }
