 ...
 * @subpackage News
 */
class News_Api_Block extends Zikula_AbstractApi {
    ...
    protected function generateWhere($args) {
        ...
        //$shop_id = !empty($_REQUEST['shop_idnewItem']) ? $_REQUEST['shop_idnewItem'] : $_REQUEST['shop_id'];
        //$wher = "AND sid IN(select news_id from zselex_shop_news  where shop_id='" . $shop_id . "')";
//        if ($_REQUEST['func'] == 'shop' || ($_REQUEST['module'] == 'ZSELEX' || $_REQUEST['func'] == 'newitem')) { //get shop articles in shop page
//            // echo "shop articles";
