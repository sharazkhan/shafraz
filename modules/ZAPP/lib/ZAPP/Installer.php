 ...
 */
class ZAPP_Installer extends Zikula_AbstractInstaller {
    ...
    public function upgrade($oldversion) {
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('ZAPP::', '::', ACCESS_ADMIN), LogUtil::getErrorMsgPermission());
