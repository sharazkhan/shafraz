 ...
 */
class Google_Controller_Admin extends Zikula_AbstractController {
    ...
    public function modifyconfig() {
        ...
        return $this->view->assign(ModUtil::getVar('goolge'))
    ...
    public function updateconfig() {
        ...
        $appid = $this->request->getPost()->get('clientid', true);
        $this->setVar('clientid', $appid);
