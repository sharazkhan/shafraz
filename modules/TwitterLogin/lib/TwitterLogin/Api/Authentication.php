 ...
 */
class TwitterLogin_Api_Authentication extends Zikula_Api_AbstractAuthentication {
    ...
    protected function postInitialize() {
        ...
        $this->authenticationMethods['TwitterLogin'] = $authenticationMethod;
    }
    ...
    public function getUidForAuthenticationInfo(array $args) {
        ...
        $connection = $this->entityManager->getRepository('TwitterLogin_Entity_Connections')
                ->findOneBy(array('twitter_id' => $args['authentication_info']['twitter_id']));
        if (!$connection) {
            $con = false;
        } else {
    ...
    public function getUidForAuththenticationInfo(array $args) {

        //echo "comes"; exit;
        //echo $args['authentication_info']['google_id']; exit;
        $authenticatedUid = false;
