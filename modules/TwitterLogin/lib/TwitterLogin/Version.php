 ...
 */
class TwitterLogin_Version extends Zikula_AbstractVersion
{
    ...
    {
        $meta = array();
        $meta['displayname'] = $this->__('TwitterLogin');
        $meta['description'] = $this->__('TwitterLogin Zikula integration module');
        $meta['url'] = $this->__('TwitterLogin');
        $meta['version'] = '1.0.0';
        $meta['core_min'] = '1.3.4'; // Fixed to 1.3.x range
        $meta['core_max'] = '1.3.99'; // Fixed to 1.3.x range
        $meta['contact'] = 'http://kaikmedia.com';
        $meta['securityschema'] = array('TwitterLogin::' => '::');
