...
(function (c, k) {
    ...
    v.prototype = {preCheckSettings: function (a) {
            ...
            this.browse_c = c('<a class="' + e + '" title="' + g("Add files") + '" />').append('<span class="' + h + '"></span> <span class="ax-text">' + g("Add files") + "</span>").appendTo(this.mainWrapper);
...
(function (d, l) {
    ...
    E.prototype = {preCheckSettings: function (a) {
            ...
            this.browse_c = d('<a class="' + c + '" title="' + g("Add files") + '" />').append('<span class="' + h + '"></span> <span class="ax-text">' + g("Add files") + "</span>").appendTo(this.mainWrapper);
