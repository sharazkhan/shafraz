/**
 * Javascript EXIF Reader - Mix code collected from internet best practice
 * Copyleft from albanx@gmail.com
 * Edit from Alban X to work with file reader http://www.albanx.com
 */
...
(function () {
    ...
    ExifReader.prototype = {
        getTag: function (oImg, strTag)
        {
            if (!oImg.exifdata)
                return;
            return oImg.exifdata[strTag];
        },
        getAllTags: function (oImg)
        {
            if (!oImg.exifdata)
                return;
        ...
        getFilePart: function (blob, start, end)
        {
            var blobSlice, start = 0, end = 2 * 131072;//256K should handle all EXIF
    ...
    var BinaryFile = function (strData, iDataOffset, iDataLength)
    {
        ...
        {
            strData = this._arrayBufferToBase64(strData);
        }
    ...
    self.addEventListener("message", function (e) {
        ...
        var blobslice = reader.readAsArrayBuffer(EXIF.getFilePart(e.data.blob));
        var binaryResponse = new BinaryFile(blobslice);
        var exif = EXIF.readExif(binaryResponse);
        postMessage({status: "end", exif: exif, progress: 0});
    }, !1);
        ...
        (function ($) {
            ...
            $.fileExif = function (file, callback)
            {
                ...
                reader.onload = function (event) {
                    ...
                    callback(EXIF.readExif(binaryResponse));
                };
