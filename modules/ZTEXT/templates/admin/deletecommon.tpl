...
<form class="z-form" action="{modurl modname='ZTEXT' type='admin' func=$submitFunc}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formbuttons z-buttons">
                ...
                <a class="z-btred" href="{modurl modname='ZTEXT' type='admin' func=$cancelFunc shop_id=$shop_id}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel'  __title='Cancel'} {gt text="Cancel"}</a>
            </div>
        </fieldset>
    </div>
