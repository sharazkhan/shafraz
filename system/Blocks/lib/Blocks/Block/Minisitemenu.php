 ...
 */
class Blocks_Block_Minisitemenu extends Zikula_Controller_AbstractBlock {
    ...
    public function display($blockinfo) {
        ...
        if (empty($vars['template'])) {
            $vars['template'] = 'blocks_block_minisiteextmenu.tpl';
        }
        // stylesheet to use
        ...
        $functions = array('site', 'minishop', 'findus', 'quickbuy');
        ...
        $this->view->assign('menuitems', $menuitems)
                ...
                ->assign('access_edit', Securityutil::checkPermission('Minisitemenu::', $blockinfo['bid'] . '::', ACCESS_EDIT));
    ...
    public function modify($blockinfo) {
        ...
        // return the output
        return $this->view->fetch('blocks_block_minisiteextmenu_modify.tpl');
    }
