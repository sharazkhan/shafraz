...
/**
 * Copyright Craig Heydenburg 2010 - ZSELEX
 *
 * ZSELEX
 ...
 */
class Blocks_Block_Zencartproducts extends Zikula_Controller_AbstractBlock {

    /**
     * initialise block
     */
    public function init() {
        SecurityUtil::registerPermissionSchema('Blocks:zencartproductsblock:', 'Block title::');
    }
    ...
    public function info() {
        return array(
            'text_type' => 'zencart',
            'module' => 'Blocks',
            'text_type_long' => $this->__('Zen Cart Products'),
            'allow_multiple' => true,
            'form_content' => false,
            'form_refresh' => false,
            'show_preview' => true,
    ...
    public function display($blockinfo) {
        if (!SecurityUtil::checkPermission('Blocks:zencartproductsblock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return;
        }
        ...
        $blockinfo['content'] = $this->view->fetch('zencartproducts.tpl');
    ...
    public function modify($blockinfo) {
        ...
        return $this->view->fetch('zencartproducts_modify.tpl');
    }
    ...
    public function update($blockinfo) {
        ...
        $this->view->clear_cache('zencartproducts.tpl');
