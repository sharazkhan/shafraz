...
{menu from=$links item='menuitem' key='itemid' name='extmenu' id='menuitemlist' class='z-itemlist' tag='ol' multilang=true}
    ...
    <li class="z-clearfix z-itemheader">
        ...
        <span class="z-itemcell z-w10"><strong>{gt text="Services" domain='zikula'}</strong></span>
    ...
    <li id="li_menuitemlist_{$itemid}" class="{cycle values='z-odd,z-even'} z-sortable z-clearfix">
        ...
        <div class="z-clearfix">
            ...
            <span class="z-itemcell z-w15">
                <input type="text" id="links_{$thislanguage}_{$itemid}_services" name="links[{$thislanguage}][{$itemid}][services]" size="25" maxlength="255" value="{$item.services|safetext}" />
            (seperate identifiers by coma)
            </span>
