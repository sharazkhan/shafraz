...
class Admin_Controller_Admin extends Zikula_AbstractController {
    ...
    public function view($args = array()) {
        ...
        $categories = array();
        $items = ModUtil::apiFunc('Admin', 'admin', 'getall', array('startnum' => $startnum,
    ...
    public function create($args) {
        ...
        $cid = ModUtil::apiFunc('Admin', 'admin', 'create', array('name' => $category['name'],
    ...
    public function update($args) {
        ...
        $update = ModUtil::apiFunc('Admin', 'admin', 'update', array('cid' => $category['cid'],
                    'name' => $category['name'],
                    'description' => $category['description']));
    ...
    public function adminpanel($args) {
        ...
        foreach ($adminmodules as $adminmodule) {
            if (SecurityUtil::checkPermission("{$adminmodule['name']}::", 'ANY', ACCESS_EDIT)) {
                ...
                $order = ModUtil::apiFunc('Admin', 'admin', 'getSortOrder', array('mid' => ModUtil::getIdFromName($adminmodule['name'])));
    ...
    public function modifyconfig() {
        ...
        foreach ($adminmodules as $adminmodule) {
            ...
            $category = ModUtil::apiFunc('Admin', 'admin', 'getmodcategory', array('mid' => ModUtil::getIdFromName($adminmodule['name'])));
    ...
    public function updateconfig() {
        ...
        foreach ($adminmodules as $adminmodule) {
            ...
            if ($category) {
                ...
                $result = ModUtil::apiFunc('Admin', 'admin', 'addmodtocategory', array('module' => $adminmodule['name'],
                            'category' => $category));
