...
<table>
    ...
    {if $vars.displayinfo eq 'yes'}
      <a class="infoclass"  id="miniShopProducts" href="{modurl modname='ZSELEX' type='info' func='displayInfo' bid=$bid}" title="{gt text=$info.title}">
