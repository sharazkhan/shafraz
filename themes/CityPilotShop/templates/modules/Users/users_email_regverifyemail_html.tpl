...
<p>{gt text='Your e-mail address (\'%1$s\') has been used to register an account on \'%2$s\' (%3$s).' tag1=$reginfo.email tag2=$sitename  tag3=$siteurl}</p>

<p>{gt text="Our system is waiting for you to verify your e-mail address."}
{if !$reginfo.isapproved}{gt text="Your request is also waiting for administrator approval."}
{if $approvalorder == 'Users_Constant::APPROVAL_AFTER'|constant}{gt text="We will not be able to approve your account until after you have completed this verification step."}{/if}
...
<p>{gt text="If you do not wish to use this web site, please either contact our site administrator, or simply disregard this message."}</p>
