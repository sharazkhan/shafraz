        ...
        <div class="PageBreak">
            ...
            <div class="FieldSet left">
             ...
             <div class="ButtonSection left NoLeftMargin">
                 ...
                 <span class="Orange" style="float:none; padding-right: 0px; text-align: right; min-width:100px; display: inline-block;cursor:pointer" onClick="window.location.href='{$baseurl}{modurl modname='ZSELEX' type='user' func='cart'}'">
                     &nbsp;&nbsp;{cartcount}
                 </span>
                 </div>
