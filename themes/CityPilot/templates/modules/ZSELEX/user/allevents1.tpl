...
<div id="pageData" class="showevents Allevents">
                ...
                <a href="{modurl modname='ZSELEX' type='user' func='viewevent' shop_id=$eventx.shop_id eventId=$eventx.shop_event_id}" class="HoverEffet">
                    <div class="DateBorder">
                        ...
                        <div class="DateHead">
                            ...
                            {* <div style="width:50px; height:50px; position:relative; z-index:999; background: url({$themepath}/images/eventlevel.png) no-repeat center; display:inline-block; float:right; margin-top:-45px; margin-right: 30px;">
                             </div> *}
    ...
    <br>
    <br>
    {*{pager rowcount=$counts limit=10 posvar='startnum'}*}
