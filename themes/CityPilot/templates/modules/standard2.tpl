    ...
    <body>
        ...
        <div class="Containter">
           {include file="includes/header.tpl"}
            ...
            <div class="Contbody">
                <div class="flash1" id="flash2">
                    <div class="FlashPop">
                        <!-- G̴ til ArticleBlock1shop-->
                    </div>
                    <div class="FlashSect1">
                        <p class="Phead">Inspiration til fysisk<br /> 
                            og mental udfoldelse</p>

                        <p class="Pcontents">
                            ArticleBlock1 r̴der og positive og faglige<br /> kompetente undervisere og foredragsholdere </p>
