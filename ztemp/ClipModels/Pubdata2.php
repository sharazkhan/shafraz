 ...
 */
class ClipModels_Pubdata2 extends Clip_Doctrine_Pubdata
{
    /**
    ...
    {
        $this->setTableName('clip_pubdata2');
        ...
        $this->hasColumn('field5 as title', 'string', 255);

        $this->hasColumn('field6 as category', 'integer', 4);

        $this->hasColumn('field7 as content', 'string', 65535);

        $this->hasColumn('field8 as displayinfo', 'boolean');
    ...
    {
        return call_user_func_array(array('ClipModels_Pubdata2Table', 'clipRelations'), array($onlyown, $field));
    }
