 ...
 */
class ClipModels_Pubdata1 extends Clip_Doctrine_Pubdata
{
    /**
    ...
    {
        $this->setTableName('clip_pubdata1');
        ...
        $this->hasColumn('field1 as title', 'string', 255);

        $this->hasColumn('field2 as content', 'string', 65535);

        $this->hasColumn('field3 as summary', 'string', 65535);

        $this->hasColumn('field4 as category', 'integer', 4);
    ...
    {
        return call_user_func_array(array('ClipModels_Pubdata1Table', 'clipRelations'), array($onlyown, $field));
    }
    ...
    public function assignClipValues(&$obj)
    {
        if (is_object($obj)) {
            ...
            $obj->mapValue('core_tid',        1);
            $obj->mapValue('core_titlefield', 'title');
