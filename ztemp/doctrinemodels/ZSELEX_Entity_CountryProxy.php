 ...
 */
class ZSELEX_Entity_CountryProxy extends \ZSELEX_Entity_Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getCountry_id();
    }

    public function setCountry_id($country_id)
    {
        $this->__load();
        return parent::setCountry_id($country_id);
    }
    ...
    {
        $this->__load();
        return parent::getCountry_name();
    }

    public function setCountry_name($country_name)
    {
        $this->__load();
        return parent::setCountry_name($country_name);
    }
    ...
    {
        $this->__load();
        return parent::getCity_countries();
    }

    public function setCity_countries($city_countries)
    {
        $this->__load();
        return parent::setCity_countries($city_countries);
    }

    public function getRegion_countries()
    {
        $this->__load();
        return parent::getRegion_countries();
    }

    public function setRegion_countries($region_countries)
    {
        $this->__load();
        return parent::setRegion_countries($region_countries);
    }

    public function getShop_countries()
    {
        $this->__load();
        return parent::getShop_countries();
    }

    public function setShop_countries($shop_countries)
    {
        $this->__load();
        return parent::setShop_countries($shop_countries);
    }
    ...
    {
        return array('__isInitialized__', 'country_id', 'country_name', 'description', 'status', 'city_countries', 'region_countries', 'area_countries', 'shop_countries', 'country_ads', 'cr_date', 'cr_uid', 'lu_date', 'lu_uid');
    }
