 ...
 */
class ZSELEX_Entity_AreaProxy extends \ZSELEX_Entity_Area implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getArea_id();
    }

    public function getArea_name()
    {
        $this->__load();
        return parent::getArea_name();
    }

    public function setArea_name($area_name)
    {
        $this->__load();
        return parent::setArea_name($area_name);
    }
    ...
    {
        return array('__isInitialized__', 'area_id', 'area_name', 'city', 'region', 'country', 'status', 'shop_areas', 'area_ads', 'cr_date', 'cr_uid', 'lu_date', 'lu_uid');
    }
