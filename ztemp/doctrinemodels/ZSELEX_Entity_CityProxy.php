 ...
 */
class ZSELEX_Entity_CityProxy extends \ZSELEX_Entity_City implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getCity_id();
    }

    public function getCity_name()
    {
        $this->__load();
        return parent::getCity_name();
    }

    public function setCity_name($city_name)
    {
        $this->__load();
        return parent::setCity_name($city_name);
    }
    ...
    {
        $this->__load();
        return parent::getCity_area();
    }

    public function setCity_area($city_area)
    {
        $this->__load();
        return parent::setCity_area($city_area);
    }
    ...
    {
        return array('__isInitialized__', 'city_id', 'city_name', 'region', 'country', 'area_cities', 'shop_cities', 'city_ads', 'description', 'status', 'cr_date', 'cr_uid', 'lu_date', 'lu_uid');
    }
