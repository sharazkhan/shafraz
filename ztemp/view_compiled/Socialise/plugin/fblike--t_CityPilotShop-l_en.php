...
<?php $this->_cache_serials['ztemp/view_compiled/Socialise/plugin/fblike--t_CityPilotShop-l_en.inc'] = 'affd0e9cfe8be31229bf377783b8ce98'; ?><?php if ($this->caching && !$this->_cache_including): echo '{nocache:affd0e9cfe8be31229bf377783b8ce98#0}'; endif;$this->_tag_stack[] = array('nocache', array()); $_block_repeat=true;Zikula_View_Resource::block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
