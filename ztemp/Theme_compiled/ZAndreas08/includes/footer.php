<?php /* Smarty version 2.6.28, created on 2017-10-01 12:25:19
...
<?php $this->_cache_serials['ztemp/Theme_compiled/ZAndreas08/includes/footer.inc'] = '5d76d915f2d8c90e318b116cfd59e8aa'; ?>                <div id="theme_footer">
...
"><?php echo smarty_function_gt(array('text' => 'Mobile version'), $this);?>
                    ...
                    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:5d76d915f2d8c90e318b116cfd59e8aa#0}'; endif;$this->_tag_stack[] = array('nocache', array()); $_block_repeat=true;Zikula_View_Resource::block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo smarty_function_pagerendertime(array(), $this);?>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo Zikula_View_Resource::block_nocache($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:5d76d915f2d8c90e318b116cfd59e8aa#0}'; endif;?>
                </div>
            </div>
