<?php /* Smarty version 2.6.28, created on 2017-12-10 11:33:46
...
<footer class="footer">
    <div class="container">
        <div class="footer-top clearfix">
            <div class="footer-logo"><img src="<?php echo $this->_tpl_vars['themepath']; ?>
/images/FooterLogo.png" alt="" width="153" height="36"></div>
...
">
            ...
            <div class="col-md-3 col-sm-12 f-social-icons">
                ...
                <ul>
                 ...
                 <?php echo smarty_function_blockposition(array('name' => 'follow-us'), $this);?>
